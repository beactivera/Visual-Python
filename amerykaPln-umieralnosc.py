...
# plt.show()
plt.savefig('plots-umieralnosc/rak-USA.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/rak-Gwatemala.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/rak-Barbados.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/choroby-USA.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/choroby-Gwatemala.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/choroby-Barbados.svg')

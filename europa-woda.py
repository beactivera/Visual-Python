...
# plt.show()
plt.savefig('plots-woda/woda-Szwajcaria.svg')
...
# plt.show()
plt.savefig('plots-woda/woda-Ukraina.svg')
...
# plt.show()
plt.savefig('plots-woda/woda-Moldawia.svg')
...
# plt.show()
plt.savefig('plots-woda/sanitarne-Europa.svg')

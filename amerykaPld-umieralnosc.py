...
# plt.show()
plt.savefig('plots-umieralnosc/rak-Argentyna.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/rak-Urugwaj.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/rak-Boliwia.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/choroby-Argentyna.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/choroby-Urugwaj.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/choroby-Boliwia.svg')

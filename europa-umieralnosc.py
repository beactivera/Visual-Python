...
# plt.show()
plt.savefig('plots-umieralnosc/rak-Szwajcaria.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/rak-Ukraina.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/rak-Moldawia.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/choroby-Szwajcaria.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/choroby-Ukraina.svg')
...
# plt.show()
plt.savefig('plots-umieralnosc/choroby-Moldawia.svg')

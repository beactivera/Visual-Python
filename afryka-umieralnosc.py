from afryka import rakSeszeleWartosci
from afryka import rakEgiptWartosci
from afryka import rakBurkinaWartosci
from afryka import chorobySeszeleWartosci
from afryka import chorobyEgiptWartosci
from afryka import chorobyBurkinaWartosci
...
# plt.show()
plt.savefig('plots-umieralnosc/rak-Szeszele.svg')


sizesRak2 = rakEgiptWartosci
...
plt.savefig('plots-umieralnosc/rak-Egipt.svg')

sizesRak3 = rakBurkinaWartosci
...
# plt.show()
plt.savefig('plots-umieralnosc/rak-Burkina.svg')
...
sizesChoroby1 = chorobySeszeleWartosci
...
# plt.show()
plt.savefig('plots-umieralnosc/choroby-Szeszele.svg')

sizesChoroby2 = chorobyEgiptWartosci
...
# plt.show()
plt.savefig('plots-umieralnosc/choroby-Egipt.svg')

sizesChoroby3 = chorobyBurkinaWartosci
...
# plt.show()
plt.savefig('plots-umieralnosc/choroby-Burkina.svg')
